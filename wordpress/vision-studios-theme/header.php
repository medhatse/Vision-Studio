...
<?php
$vs_nav = [
	[ home_url( '/#studios' ), __( 'Studios', 'vision-studios' ) ],
...
<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="flex items-center gap-3 shrink-0" aria-label="<?php esc_attr_e( 'Vision Studios home', 'vision-studios' ); ?>"><img src="<?php echo esc_url( $vs_logo ); ?>" alt="" class="h-8 w-auto"/><span class="font-display uppercase leading-none text-lg tracking-wide">Vision<span class="block text-[10px] font-mono-tag tracking-[0.2em] text-white/50 -mt-0.5">Studios</span></span></a>
