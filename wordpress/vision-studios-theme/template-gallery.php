...
$cities = vs_cities();
$hero   = get_the_post_thumbnail_url( null, 'vs-wide' ) ?: ( $items ? vs_img_url( $items[0][0], 'vs-wide' ) : '' );
echo vs_page_hero( __( 'From Behind<br/><span class="text-accent">The Lens.</span>', 'vision-studios' ), sprintf( __( '%1$d photographs from %2$d studios across four cities.', 'vision-studios' ), count( $items ), count( $studios ) ), (string) $hero, __( 'Gallery', 'vision-studios' ) ); // phpcs:ignore
?>
