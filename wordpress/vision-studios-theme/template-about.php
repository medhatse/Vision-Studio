...
the_post();
$sub = get_the_excerpt();
echo vs_page_hero( __( 'Who Is<br/><span class="text-accent">Vision Studios.</span>', 'vision-studios' ), $sub, (string) get_the_post_thumbnail_url( null, 'vs-wide' ), __( 'About Us', 'vision-studios' ) ); // phpcs:ignore
?>
